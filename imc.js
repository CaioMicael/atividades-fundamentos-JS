function CalculaIMC() {
    ...
    if (resultadoCalculo < 18.50) {
        ...
        resultado += nome + ' Seu resultado do IMC é pré obesidade, seu IMC é ' + resultadoCalculo.toFixed(2);
    }

    else if (resultadoCalculo >= 30.00 && resultadoCalculo <= 34.99) {
        resultado += nome + ' Seu resultado do IMC é obesidade grau 1, seu IMC é ' + resultadoCalculo.toFixed(2);
    }

    else if (resultadoCalculo >= 35.00 && resultadoCalculo <= 39.99) {
        resultado += nome + ' Seu resultado do IMC é obesidade grau 2, seu IMC é ' + resultadoCalculo.toFixed(2);
    }

    else if (resultadoCalculo >= 40) {
        resultado += nome + ' Seu resultado do IMC é obesidade grau 3, seu IMC é ' + resultadoCalculo.toFixed(2);
    }
